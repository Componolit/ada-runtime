...
SRC = a-except.adb a-unccon.ads ada.ads i-c.adb i-cexten.ads i-cstrin.adb interfac.ads platform.adb ss_utils.adb s-exctab.adb s-imgint.adb s-init.adb s-parame.ads s-secsta.adb s-soflin.adb s-stalib.ads s-stoele.adb system.ads argv.c exit.c init.c ada_exceptions.ads s-unstyp.ads
