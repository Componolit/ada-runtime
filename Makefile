...
SRC = a-except.adb a-unccon.ads ada.ads i-c.adb i-cexten.ads i-cstrin.adb interfac.ads external.adb ss_utils.adb s-exctab.adb s-parame.adb s-secsta.adb s-soflin.adb s-stalib.ads s-stoele.adb system.ads
